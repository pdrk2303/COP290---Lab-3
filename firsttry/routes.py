...
from firsttry.forms import RegisterationForm, LoginForm, UpdateAccountForm, PostForm
from firsttry.models import User, Post
...
def account():
    ...
    return render_template('account-final.html', title='Account', image_file=image_file, form=form)
